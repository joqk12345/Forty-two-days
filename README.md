...
- 当前预出版版本：`0.4.0`。
- 42章正文完整，约11.8万字符；每章均有一首章首诗。
- 第二稿已经完成结构去重、史实核验、称谓统一和全稿高频句式精修。
- 已完成全42章章首诗嵌入，并将诗歌暗线分为“名与信”“时间与城”“火与水”“胜后余波”四个阶段。
- 已完成第15—24天战役段重构：明确安庆以守争时间、南昌以攻夺根本的双线因果，并补强七门部署、后勤支援、入城接管与宁王回师逻辑。
...
当前版本为 `0.4.0`。项目变更见 [CHANGELOG.md](CHANGELOG.md)。
